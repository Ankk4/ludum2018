...
namespace LitJson
{
    ...
    public class JsonMapper
    {
        ...
        static JsonMapper ()
        {
            ...
            Registeplayer_rbaseExporters ();
            Registeplayer_rbaseImporters ();
        }
        #endregion
        ...
        private static void Registeplayer_rbaseExporters ()
        {
        ...
        private static void Registeplayer_rbaseImporters ()
        {
            ImporterFunc importer;
